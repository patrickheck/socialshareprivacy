...
$.fn.socialSharePrivacy=function(settings){var defaults={'services':{'facebook':{'status':'on','dummy_img':'socialshareprivacy/images/dummy_facebook_en.png','txt_info':'2 clicks for privacy: if you click here, you activate the facebook button and you can recommend this site. When the facebook button is activated, your personal data will be transmitted to third parties. See <em>i</em>.','txt_fb_off':'not connected with Facebook','txt_fb_on':'connected with Facebook','perma_option':'on','display_name':'Facebook','referrer_track':'','language':'en_US','action':'recommend'},'twitter':{'status':'on','dummy_img':'socialshareprivacy/images/dummy_twitter.png','txt_info':'2 clicks for privacy: if you click here, you activate the twitter button and you can share this site. When the twitter button is activated, your personal data will be transmitted to third parties. See <em>i</em>.','txt_twitter_off':'not connected with Twitter','txt_twitter_on':'connected with Twitter','perma_option':'on','display_name':'Twitter','referrer_track':'','tweet_text':getTweetText,'language':'en'},'gplus':{'status':'on','dummy_img':'socialshareprivacy/images/dummy_gplus.png','txt_info':'2 clicks for privacy: if you click here, you activate the Google+ button and you can share this site. When the Google+ button is activated, your personal data will be transmitted to third parties. See <em>i</em>.','txt_gplus_off':'not connected with Google+','txt_gplus_on':'connected with Google+','perma_option':'on','display_name':'Google+','referrer_track':'','language':'de'}},'info_link':'http://h4ck3rm1k3.github.com/socialshareprivacy/','txt_help':'If you activate the buttons here, your private information will be transmitted to Facebook, Twitter or Google in USA and may be saved there. For more information, click here <em>i</em>.','settings_perma':'Activate Permanently and agree to always transfer your personal information (uses cookies):','cookie_path':'/','cookie_domain':document.location.host,'cookie_expires':'365','css_path':'socialshareprivacy/socialshareprivacy.css','uri':getURI};var options=$.extend(true,defaults,settings);var facebook_on=(options.services.facebook.status==='on');var twitter_on=(options.services.twitter.status==='on');var gplus_on=(options.services.gplus.status==='on');if(!facebook_on&&!twitter_on&&!gplus_on){return;}
...
if(gplus_on&&gplus_perma&&cookies.socialSharePrivacy_gplus==='perma_on'){$('li.gplus span.switch',context).click();}}});};}(jQuery));